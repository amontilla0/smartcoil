...
class RelayController():
    '''Serves as the class that controls the 4-channel relay module that deals
    directly with the Fan Coil Unit (FCU).'''
    ...
    def set_relay_to(self, rel, value):
        ...
        Args:
            ...
            value (bool): Either True to turn on a signal, or False for the
                opposite.
        '''
    ...
    def start_coil_at(self, speed):
        ...
        Args:
            speed (int): 1 for low speed, 2 for mid speed and 3 for high speed.
                The value 0 turns off the FCU.
        '''
    ...
    def set_all_to(self, value):
        '''Helper method to turn all the relays to the same value. Useful to
        turn everything off.
